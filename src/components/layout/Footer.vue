<template>
  <footer>
    <div class="footer-links gen-padding d-flex justify-content-center">
    ...
    <div class="footer-socials gen-padding d-flex justify-content-center">
      <a href="#">
        <svg
          version="1.1"
          id="Capa_1"
    ...
    >
      <span>
        &copy; 2019 Codedrills Education Private Limited
      </span>
      <div>
